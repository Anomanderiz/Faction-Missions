insert into public.faction_missions (faction, title, reward, location, hook, status, assigned_to, notes)
values
...
insert into public.story_arcs (title, type, blurb, is_visible)
values
